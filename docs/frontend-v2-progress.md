...
F08检查点9ff55a8已合入frontend/v2。当前分支frontend/f09-acceptance，F09验收已收口，正在形成本地检查点。09正式13人首局终局/第二局启动通过；10恢复双浏览器各3/3、11特殊行动各1/1、12治理重连各3/3、14账号异常各2/2及07管理导航各1/1通过。真实命令覆盖18类，证据及边界见验收台账。F10生产构建脚本、请求ID兼容及可选同源静态入口已接入；Dockerfile与本地5174编排已准备，尚未构建或启动最终候选。全项目验收尚未完成，下一步为最终镜像门禁及同源产物验证。
...
| F06 信息规则 | 核心通过 | tracker8例，05双浏览器各4例；真实聊天06两浏览器通过 |
| F07 观战复盘 | 核心通过/完整局待验 | 06真实授权链两浏览器各2例；07复盘夹具各4例；正式局终局/再开局留F09 |
...
| F10 完整本地交付 | 准备中 | 生产前端构建已通过；可选静态入口及本地编排待完整镜像联验，不切换原服务、不发布公网 |
